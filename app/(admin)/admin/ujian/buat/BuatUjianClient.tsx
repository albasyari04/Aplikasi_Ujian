...
// app/(admin)/admin/ujian/buat/BuatUjianClient.tsx
...
// ✅ Daftar kelas — sesuaikan dengan data sekolah
const DAFTAR_KELAS = [
...
export function BuatUjianClient() {
  ...
  const [form, setForm] = useState({
    ...
    waktuSelesai: "",
    durasi: "90",
    // ✅ FIX #1: Default "AKTIF" agar ujian langsung terlihat siswa
    // Sebelumnya "DRAFT" menyebabkan ujian tidak muncul di sisi siswa
    status: "AKTIF",
  })
    ...
    <div className="w-full space-y-5 pb-24">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {isPending ? "Menyimpan..." : "Simpan Ujian"}
              </button>
            </div>
          </div>

          <div>
            <h1 className="text-xl font-bold text-white mb-1">Buat Ujian Baru</h1>
            <p className="text-teal-200/70 text-sm">Isi semua informasi ujian di bawah ini</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-background rounded-2xl shadow-sm border border-border/50 overflow-hidden">
        ...
        <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* ✅ FIX #1: Status default AKTIF + visual warning yang jelas */}
          <div className="space-y-1.5">
            <label className="flex items-center gap-1.5 text-[10px] font-extrabold text-muted-foreground uppercase tracking-widest">
            ...
            {/* ✅ BARU: Visual indicator status yang dipilih */}
            {form.status === "AKTIF" ? (
      ...
      <div className="flex items-start gap-2.5 px-4 py-3 rounded-2xl bg-muted/30 border border-border/40">
        ...
        <p className="text-xs text-muted-foreground/60 leading-relaxed">
          Ujian dengan status <strong className="text-muted-foreground">Aktif</strong> akan langsung terlihat
          oleh siswa sesuai kelas target. Status{" "}
          <strong className="text-muted-foreground">Draft</strong> menyembunyikan ujian dari siswa.
          Setelah ujian dibuat, tambahkan soal melalui menu{" "}
          <strong className="text-muted-foreground">Kelola Soal</strong>.
        </p>
      </div>
